...
- フリーランスであるため、権限の関係で本番環境へのデプロイの経験が少ない

## キャリアの方向性に関して

- アーキテクトとして、キャリアを積んでいきたい
  - ライブラリや実装方法だけではなく、もっと高い視点からシステム全体を俯瞰できると、問題解決が容易になることが多いと感じたため
  - フロントエンドとバックエンドの区別はなく、フルスタックエンジニアとして活躍できるようになりたい
  - ソフトウェア関連に関してはある程度達成できたと思ってるので、これから先はもっとインフラやミドルウェアも含めて高い視点から見ていきたい
...
- LLM
  - chatgpt
    - 新しい機能がよく入る
  - claude
    - claude artifacts でプレビューしながらアプリを作れる
  - gemini
    - 入出力できるコンテキスト量が大きいので要約等に使う
  - dify
    - GUI で簡単に LLM エージェントを作れる
  - LangGraph
    - 複雑な LLM エージェントを作れる
